...
const TrendingProducts = async () => {
  ...
  return (
    <div className=" bg-slate-500 min-h-screen m-0">
      ...
      <section className="productCardSection px-4 py-3 flex flex-wrap gap-5 justify-center item-center">
        {allProducts?.map((ele: STOREDATA, ind: number) => {
          return (
            <div
